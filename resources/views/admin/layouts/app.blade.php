...
<body class="bg-gray-100">
    ...
    <div
        ...
        <div class="relative mx-6 sm:mx-0">
            ...
            <input class="form-input w-36 sm:w-64 border-2 rounded border-gray-200 pl-10 pr-4 focus:border-indigo-600"
    ...
    <div class="h-screen flex flex-row flex-wrap">
        ...
        <!-- start sidebar -->
        <div id="sideBar"
            class="relative flex flex-col flex-wrap bg-gray-900 border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
