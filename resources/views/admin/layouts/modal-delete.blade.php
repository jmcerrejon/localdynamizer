    ...
    <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
      ...
      <div class="modal-content py-4 text-left px-6">
        ...
        <div class="flex justify-end pt-2">
            ...
            <form id="formDelete" action="{{ route('dynamizers.destroy', 1) }}" method="post">
                @csrf
                @method('DELETE')
                <input type="hidden" id="id">
                <button type="submit" class="px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400">Si, deseo eliminarlo</button>
            </form>
        </div>
